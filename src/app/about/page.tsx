  ...
  return (
    <div className="min-h-screen bg-[#f8f7f4] text-[#0d0d0d] overflow-x-hidden" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <div className="wa-fab-wrapper">
        ...
        <a href="https://wa.me/917249822874?text=Hi%2C%20I%27m%20interested%20in%20joining%20the%20Achievers%20Club%20Nashik%20Branch!" target="_blank" rel="noopener noreferrer" className="wa-fab" aria-label="Chat on WhatsApp">
