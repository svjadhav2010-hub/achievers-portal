...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // TODO: wire up to a real API route or EmailJS / Resend
  ...
  return (
    <div className="min-h-screen bg-[#f8f7f4] text-[#0d0d0d] overflow-x-hidden" style={{ fontFamily: 'var(--font-sans)' }}>
      ...
      <div className="wa-fab-wrapper">
        ...
        <a href="https://wa.me/91XXXXXXXXXX?text=Hi%2C%20I%20have%20a%20question%20about%20the%20Achievers%20Club!" target="_blank" rel="noopener noreferrer" className="wa-fab" aria-label="Chat on WhatsApp">
