  ...
  return (
    <div className="min-h-screen bg-[#f8f7f4] text-[#0d0d0d] overflow-x-hidden" style={{ fontFamily: 'var(--font-sans)' }}>
          ...
          <div className="stay-updated-inner" style={{ background: '#0d0d0d', borderRadius: 36, padding: '80px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{ position: 'relative', zIndex: 1 }}>
              ...
              <div style={{ display: 'flex', gap: 14, justifyContent: 'center', flexWrap: 'wrap' }}>
                ...
                <a href="https://wa.me/917249822874?text=Hi%2C%20please%20add%20me%20to%20the%20events%20list!" target="_blank" rel="noopener noreferrer" className="btn-ghost" style={{ color: 'rgba(255,255,255,0.6)', borderColor: 'rgba(255,255,255,0.15)' }}>
                  WhatsApp updates
                </a>
              </div>
            </div>
      ...
      <div className="wa-fab-wrapper">
        ...
        <a href="https://wa.me/917249822874?text=Hi%2C%20I%27m%20interested%20in%20the%20Achievers%20Club%20events!" target="_blank" rel="noopener noreferrer" className="wa-fab" aria-label="Chat on WhatsApp">
